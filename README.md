...
## Prerequisites
- [Open CASCADE Technology](https://www.opencascade.com/content/latest-release) (OCCT) 7.5.0 or higher (64 bit)
...
- Use [CMake](https://cmake.org/) 3.12.2 or higher to build the software.
  - vc14 or higher should be selected for the generator.
